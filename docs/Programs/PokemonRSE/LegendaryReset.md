...
Shiny hunt legendary Pokemon using soft resets. Ruby/Sapphire only.

This program works for the following legendaries:

* Groudon, Kyogre
* Rayquaza
* Regirock, Registeel, Regice
* Latios/Latias (Southern Island)

It also works for:

* Voltorb, Electrode (Mimics)
* Kecleon
...
1. Stand in front of your target and save the game.
    - For Kyogre and Groudon stand one tile before your target. (See below.)
2. Start the program in game.    

<img src="images/LegendaryReset-1.jpg">
